...
<div class="content">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Laporan Data Surat Masuk</h3>
        </div>
        ...
        <form  id="form" method="GET">
            <div class="row mt-4 g-6 align-items-center">
                    ...
                    <a href="export/cetak_datasuratmasuk.php" target="_blank" class="btn btn-info float-right">Cetak Semua Data Disetujui</a>
                    </div>
                    <br>
                </div>
            </form>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $("#Pilih").click(function(){
                ...
                $.ajax({
                    type	: 'GET',
                    url	: "pages/admin/ambil_suratmasuk.php",
                    data: data,
                    cache	: false,
